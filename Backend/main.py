...
#         # --- Step 1: Dimensions before orientation
#         bounds_before = mesh.bounds
#         dims_before = (bounds_before[1] - bounds_before[0]).tolist()

#         # --- Step 2: PCA alignment (align to principal axes)
...
#         front_faces = [
#             (i, np.dot(face_normals[i], y_axis))
...
#         # --- Step 5: Dimensions after orientation (upright view)
#         bounds_after = mesh.bounds
#         dims_after = (bounds_after[1] - bounds_after[0]).tolist()

#         # Optional: Export the oriented mesh
#         # oriented_path = tmp_path.replace(".stl", "_oriented.stl")
...
#             "dimensions_before": {
#                 "x": round(dims_before[0], 2),
#                 "y": round(dims_before[1], 2),
#                 "z": round(dims_before[2], 2)
#             },
#             "dimensions_after": {
#                 "x": round(dims_after[0], 2),
#                 "y": round(dims_after[1], 2),
#                 "z": round(dims_after[2], 2)
#             },
#         })
...
# from trimesh.geometry import align_vectors
# from fastapi.middleware.cors import CORSMiddleware
# from Backend.process_model import upload_stl
...
# @app.post("/auto-orient/")
# async def auto_orient(file: UploadFile = File(...)):
#     # Save uploaded STL file
...
#     # Return both before and after dimensions + download link
#     return {
#         "dimensions_before": {
#             "x": round(dims_before[0], 2),
#             "y": round(dims_before[1], 2),
